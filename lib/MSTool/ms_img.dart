...
class MSImg extends StatelessWidget {
  final String name;
  final double? width;
  final double? height;
  final double? size;
  ...
  const MSImg({super.key, required this.name, this.size, this.width, this.height, this.fit = BoxFit.fill});
...
DecorationImage MSDImg(String name, {BoxFit fit = BoxFit.fill}) {
  var p = "$name".image();
...
class MSBouncyImage extends StatefulWidget {
  ...
  @override
  State<MSBouncyImage> createState() => _MSBouncyImageState();
}

class _MSBouncyImageState extends State<MSBouncyImage>
  ...
  @override
  void didUpdateWidget(covariant MSBouncyImage oldWidget) {
