...
class MSGradientText extends StatelessWidget {
  final String text;
...
class MSGradientStrokeText extends StatelessWidget {
  final String text;
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: CustomPaint(
        painter: _MSGradientStrokeTextPainter(
          text: text,
...
class _MSGradientStrokeTextPainter extends CustomPainter {
  final String text;
  final List<Color> gradientColors;
  final Color strokeColor;
  final double strokeWidth;
